...
<head>
    ...
    <title>Student Complaint Registration System</title>
...
<body>
    ...
    <div class="login-container">
        <div class="wellness-card">
            ...
            <div class="mindful-header">
                ...
                <p>Enter your Query and get it Sorted out!!!!</p>
            </div>
            <form action="index.php" class="harmony-form" id="loginForm" method="post">
                <?php
                    if(isset($_POST['loginBtn']))
                    {
                        if(isset($successmsg))
                ...
                <div class="mindful-options">
                    ...
                    <a href="#" class="healing-link">Reset</a>
                </div>

                <button type="submit" class="harmony-button" name="loginBtn">
    ...
    <script src="http://localhost/ComplaintRegistration/js/formutil.js"></script>
   <!-- <script src="http://localhost/ComplaintRegistration/js/script.js"></script>-->
</body>
</html>